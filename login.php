	...
	<section class="bg-gray-50 dark:bg-gray-900 relative bg-cover lg:relative lg:bg-cover lg:bg-center lg:bg-no-repeat"
		...
		<div class="bg-transparent py-6 sm:py-8 lg:py-12">
			<div class="mx-auto max-w-screen-2xl px-4 md:px-8">
				<h2 class="mb-4 text-center text-xl font-bold text-green-900 md:mb-8 lg:text-3xl">Login To Cara</h2>


				<form class="bg-white  mx-auto max-w-lg rounded-2xl border z-50" method="post">
					...
					<div class="flex items-center justify-center bg-gray-100 p-4 rounded-xl z-50">
						<p class="text-center text-sm text-gray-500">Don't have an account? <a href="signup.php"
